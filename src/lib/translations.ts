...
export const translations = {
  en: {
    ...
    shortsTitle: 'Viral Shorts & Reels (Captions & Quality)',
    ...
    motionTitle: 'Motion Graphics & 2D Animation',
    ...
    thumbnailTitle: 'Thumbnails & Content Strategy',
  ...
  hi: {
    ...
    shortsTitle: 'वायरल शॉर्ट्स और रील्स (कैप्शन और क्वालिटी)',
    ...
    motionTitle: 'मोशन ग्राफिक्स और 2D एनिमेशन',
    ...
    thumbnailTitle: 'थंबनेल और कंटेंट स्ट्रेटेजी',
