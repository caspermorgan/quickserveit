...
export const translations = {
  en: {
    ...
    instAboutMissionContentHindi: 'मैंने यह सेवा इसलिए शुरू की क्योंकि मैंने शिक्षकों को डिजिटल कागजी कार्रवाई में डूबते देखा। मेरा मिशन सरल है: आपके दस्तावेज़ीकरण का बोझ संभालना ताकि आप शिक्षा पर ध्यान केंद्रित कर सकें।',
    ...
    instAboutPrivacyTitleHindi: 'गोपनीयता सर्वप्रथम',
    ...
    instAboutSpeedTitleHindi: 'विश्वसनीय डिलीवरी',
    ...
    instAboutFormatTitleHindi: 'तकनीकी सटीकता',
    ...
    instAboutFounderTeaserTitle: 'Meet the Person Behind the Service',
    instAboutFounderTeaserSubtext: 'Meet the Lead System Architect. The person responsible for your data security.',
    ...
    crAboutPhilosophyContentHindi: 'मैं सिर्फ वीडियो एडिट नहीं करता — मैं ध्यान को इंजीनियर करता हूं। हर कट, हर ट्रांज़िशन, हर साउंड इफेक्ट आपके दर्शकों को बांधे रखने के लिए डिज़ाइन किया गया है।',
    ...
    crAboutFounderTeaserTitle: 'Meet the Editor',
    crAboutFounderTeaserSubtext: 'Meet Your New Creative Partner. I don\'t just edit; I engineer attention.',
