...
export const translations = {
  en: {
    ...
    pricingHeroTitle: 'Professional Institutional Pricing',
    pricingHeroSubtitle: 'Scope-based pricing for serious institutions. Only what is written here is promised and delivered.',
    pricingTrust1: 'No Hidden Fees',
    pricingTrust2: 'Clear Terms',
    pricingTrust3: 'Zero-Rejection Guarantee',

    // Pricing Page - Institutional Tab 1 (Documentation)
    pricingInstTab1Label: 'Documentation',
    ...
    pricingInstItem3Name: 'Maths / Science',
    pricingInstItem3Desc: 'Formulas, diagrams, equations',
    pricingInstItem3Price: '₹30/page',
    pricingInstTab1Highlight: 'Error-free formatting optimized for bulk printing. Includes equation editor, diagram support, and professional layout.',

    // Pricing Page - Institutional Tab 2 (Data Services)
    pricingInstTab2Label: 'Data Services',
    pricingInstTab2Title: 'Data Architecture',
    ...
    pricingInstTab2Highlight: '99.9% acceptance rate on first submission. We handle re-submissions at no extra cost.',

    // Pricing Page - Institutional Tab 3 (Terms)
    pricingInstTab3Label: 'Terms',
    pricingInstTab3Title: 'Terms & Protocol',
    pricingInstTab3Desc: 'The professional handshake - clear terms, secure workflow',
    pricingInstPolicy1Title: 'Payment Terms',
    pricingInstPolicy1Item1Label: 'Small Tasks: 100% Advance',
    pricingInstPolicy1Item1Desc: 'Full payment before starting',
    pricingInstPolicy1Item2Label: 'Large Work: 50% Advance',
    pricingInstPolicy1Item2Desc: 'Work starts only after confirmation',
    pricingInstPolicy2Title: 'Corrections Policy',
    pricingInstPolicy2Item1Label: 'Minor Corrections Included',
    pricingInstPolicy2Item1Desc: 'Within agreed scope',
    pricingInstPolicy2Item2Label: 'New Ideas Charged Separately',
    pricingInstPolicy2Item2Desc: 'Late changes outside original scope',
    pricingInstTab3Highlight: 'Built on mutual respect and transparency. Our terms protect both parties and ensure smooth collaboration.',

    // Pricing Page - Creator Tab 1 (Video Plans)
    ...
    pricingCreatorPlan1Note: 'Clean, professional basics',
    pricingCreatorPlan2Name: 'Growth',
    pricingCreatorPlan2Price: '₹1,999',
    pricingCreatorPlan2Desc: 'Narrative-focused',
    ...
    pricingCreatorPlan2Note: 'Narrative-focused editing',
    ...
    pricingCreatorPlan3Note: 'Premium production',
    ...
    pricingCreatorPlan4Note: 'Multi-episode series',
    pricingCreatorTab1Highlight: 'Professional 1080p delivery with cinematic color grading. All packages include platform-ready formatting and up to 2 rounds of revisions.',

    // Pricing Page - Creator Tab 2 (Shorts)
    ...
    pricingCreatorTab2Highlight: 'Optimized for Instagram Reels, YouTube Shorts, and TikTok. Includes trending audio selection and platform-specific formatting.',

    // Pricing Page - Creator Tab 3 (Design)
    ...
    pricingCreatorDesign1Note: 'Perfect for intros, transitions, lower thirds',
    ...
    pricingCreatorDesign2Note: 'Includes script writing, A/B testing guidance',
    pricingCreatorTab3Highlight: 'Professional design services to elevate your content. All deliverables include source files and up to 2 rounds of revisions.',

    // Pricing Page - Creator Tab 4 (Terms)
    pricingCreatorTab4Label: 'Terms',
    pricingCreatorTab4Title: 'Terms & Workflow',
  ...
  hi: {
    ...
    contactHeroSubtitle: 'कोई प्रोजेक्ट है? आइए चर्चा करें कि हम कैसे मदद कर सकते हैं।',

    // Contact Methods - Hindi
    whatsappContact: 'WhatsApp',
    whatsappDesc: 'काम के समय में हमसे संपर्क का सबसे तेज़ तरीका',
    emailContact: 'ईमेल',
    emailDesc: 'विस्तृत पूछताछ और दस्तावेज़ीकरण के लिए',
    locationContact: 'स्थान',
    locationDesc: 'गोरखपुर, उत्तर प्रदेश, भारत',

    // Contact FAQ - Hindi
    contactFaqTitle: 'सामान्य प्रश्न',
    contactFaqQ1: 'आपके काम के घंटे क्या हैं?',
    contactFaqA1: 'सोमवार से शनिवार, सुबह 10:00 बजे से शाम 4:00 बजे IST। इस समय के बाहर भेजे गए संदेशों का जवाब अगले कार्य दिवस पर दिया जाएगा।',
    contactFaqQ2: 'आप कितनी जल्दी जवाब देते हैं?',
    contactFaqA2: 'काम के घंटों के दौरान, हम 2-4 घंटे के भीतर जवाब देने का लक्ष्य रखते हैं। तत्काल संस्थागत कार्य के लिए, कृपया अपने संदेश में "तत्काल" का उल्लेख करें।',
    contactFaqQ3: 'क्या आप आपातकालीन सहायता प्रदान करते हैं?',
    contactFaqA3: 'हम तत्काल संस्थागत समय-सीमा और क्रिएटर लॉन्च शेड्यूल को प्राथमिकता देते हैं। विवरण के साथ हमसे संपर्क करें, और हम आकलन करेंगे कि क्या हम जल्दबाजी के काम को समायोजित कर सकते हैं।',

    // Contact Info Cards - Hindi
    responseTime: 'प्रतिक्रिया समय',
    responseTimeValue: 'काम के घंटों के दौरान 2-4 घंटे',
    projectScope: 'प्रोजेक्ट दायरा',
    projectScopeValue: 'केवल संस्थागत और क्रिएटर सेवाएं',
    dataPrivacy: 'डेटा गोपनीयता',
    dataPrivacyValue: 'सख्त गोपनीयता की गारंटी',

    // About Page - Hindi
    aboutHeroTitle: 'quickserveit के बारे में',
    aboutHeroSubtitle: 'हम उन लोगों के लिए डिजिटल बोझ कम करने के लिए मौजूद हैं जो सार्थक कार्य करते हैं — चाहे वह अगली पीढ़ी को शिक्षित करना हो या कंटेंट के माध्यम से दर्शक बनाना।',

    // Purpose Section - Hindi
    ourPurpose: 'हमारा उद्देश्य',
    purposeText: 'हम दो अलग दुनियाओं की समान गहराई से सेवा करते हैं: अनुपालन कागजी कार्रवाई में डूबे शैक्षणिक संस्थान, और उत्पादन बाधाओं से जूझ रहे कंटेंट क्रिएटर्स। हमारा मिशन सरल है — तकनीकी अराजकता को संभालें ताकि आप अपने सर्वश्रेष्ठ काम पर ध्यान केंद्रित कर सकें।',

    // Working Principles - Hindi
    howWeWork: 'हम कैसे काम करते हैं',
    principle1: 'गोपनीयता सर्वोपरि',
    principle1Desc: 'हर फाइल, हर बातचीत, हर डेटा को विवेक के साथ संभाला जाता है। हम संस्थागत रिकॉर्ड और क्रिएटर कंटेंट दोनों की संवेदनशीलता को समझते हैं।',
    principle2: 'यथार्थवादी समय-सीमा',
    principle2Desc: 'हम अधिक वादे नहीं करते। स्पष्ट समय-सीमा, ईमानदार अनुमान, और किसी भी देरी के बारे में पारदर्शी संचार की अपेक्षा करें। जल्दबाजी का काम खराब काम है।',
    principle3: 'शांत संचार',
    principle3Desc: 'कोई आक्रामक फॉलो-अप नहीं, कोई जबरदस्त बिक्री नहीं। हम काम के घंटों के दौरान जवाब देते हैं, संदेश स्पष्ट रखते हैं, और आपके समय का सम्मान करते हैं।',
    principle4: 'केंद्रित विशेषज्ञता',
    principle4Desc: 'हम सब कुछ नहीं करते। हम संस्थागत दस्तावेज़ीकरण और क्रिएटर प्रोडक्शन करते हैं — गहराई से और उत्कृष्टता से। यही हमारा फोकस है।',

    // Who We Serve - Hindi
    whoWeServeTitle: 'हम किसकी सेवा करते हैं',
    institutionsTitle: 'संस्थान',
    institutionsDesc: 'दस्तावेज़ीकरण सहायता की आवश्यकता वाले स्कूल और कॉलेज|UDISE+, परीक्षा, छात्रवृत्ति प्रबंधित करने वाले प्रशासक|अनुपालन सहायता की आवश्यकता वाले शैक्षिक ट्रस्ट|विश्वसनीय डिजिटल साझेदार खोजने वाले स्कूल',
    creatorsTitle: 'क्रिएटर्स',
    creatorsDesc: 'प्रोफेशनल एडिटिंग सहायता की आवश्यकता वाले YouTubers|ऑनलाइन कोर्स कंटेंट बनाने वाले शिक्षक|विज़ुअल कंटेंट की आवश्यकता वाले पॉडकास्टर्स|प्रीमियम प्रोडक्शन गुणवत्ता चाहने वाले ब्रांड्स',

    // What We Don't Do - Hindi
    whatWeDontDoTitle: 'हम क्या नहीं करते',
    transparencyTitle: 'पारदर्शिता मायने रखती है',
    transparencyText: 'यहां वह है जो हमारे दायरे से बाहर है:',
    dontDoItems: 'छात्रों के लिए शैक्षणिक लेखन या कंटेंट निर्माण|गारंटीड व्यूज, सब्सक्राइबर्स या मुद्रीकरण|किसी भी संस्थागत रिकॉर्ड में हेराफेरी|24/7 उपलब्धता या तत्काल प्रतिक्रियाएं|वेब डेवलपमेंट या सॉफ्टवेयर प्रोजेक्ट्स|सोशल मीडिया प्रबंधन या मार्केटिंग',

    // Working Hours Section - Hindi
    workingHoursTitle: 'काम का समय',
    workingHoursText: 'सहायता समय: सुबह 10 से शाम 4 बजे (IST)',
    workingDaysText: 'सोमवार से शनिवार',
    outsideHoursText: 'इस समय के बाहर भेजे गए संदेशों का जवाब अगले कार्य दिवस पर दिया जाएगा।',

    // Pricing Page - Hindi
    pricingHeroTitle: 'पारदर्शी मूल्य निर्धारण',
    pricingHeroSubtitle: 'कोई छिपी हुई फीस नहीं। स्पष्ट दायरा। ईमानदार समय-सीमा।',

    // Institutional Pricing - Hindi
    instPricingTitle: 'संस्थागत सेवाएं',
    perTaskTitle: 'प्रति-कार्य',
    perTaskSubtitle: 'कभी-कभी दस्तावेज़ीकरण आवश्यकताओं के लिए',
    perTaskPrice: 'कोटेशन-आधारित',
    perTaskFeaturesList: 'एकल प्रोजेक्ट स्कोप|मानक समय-सीमा|WhatsApp सहायता|1 रिवीज़न राउंड',

    monthlyRetainerTitle: 'मासिक रिटेनर',
    monthlyRetainerSubtitle: 'नियमित आवश्यकताओं वाले स्कूलों के लिए',
    monthlyRetainerPrice: 'कस्टम',
    monthlyRetainerFeaturesList: 'प्राथमिकता सहायता|तेज़ टर्नअराउंड|समर्पित चैनल|असीमित छोटे कार्य|मासिक रिपोर्टिंग',

    annualPartnershipTitle: 'वार्षिक साझेदारी',
    annualPartnershipSubtitle: 'दीर्घकालिक सहयोग के लिए',
    annualPartnershipFeaturesList: 'सभी रिटेनर लाभ|रियायती दरें|वार्षिक योजना सहायता|प्राथमिकता शेड्यूलिंग|समर्पित खाता प्रबंधक',

    // Subscription Tiers - Hindi
    silverPlanTitle: 'सिल्वर',
    silverPlanPrice: 'कस्टम',
    silverPlanFeaturesList: '30 माइक्रो-टास्क प्रति माह|12 पेज नोटिस टाइपिंग|मामूली टाइमटेबल एडिट्स|स्टैंडर्ड सपोर्ट (4-6 घंटे)|WhatsApp सहायता',

    goldPlanTitle: 'गोल्ड',
    goldPlanPrice: 'कस्टम',
    goldPlanFeaturesList: 'सिल्वर में सब कुछ|फुल टाइमटेबल (1/माह)|100 सर्टिफिकेट नाम|PPT फॉर्मेटिंग|प्राथमिकता कतार सपोर्ट',

    platinumPlanTitle: 'प्लेटिनम',
    platinumPlanPrice: 'कस्टम',
    platinumPlanFeaturesList: 'गोल्ड में सब कुछ|मल्टी-डिपार्टमेंट कोऑर्डिनेशन|बड़े सर्टिफिकेट बैच|जटिल शेड्यूलिंग|सबसे तेज़ टर्नअराउंड',

    // Creator Pricing - Hindi
    creatorPricingTitle: 'क्रिएटर सेवाएं',
    singleVideoTitle: 'सिंगल वीडियो',
    singleVideoSubtitle: 'व्यक्तिगत प्रोजेक्ट्स के लिए',
    singleVideoPrice: '₹2,500 से',
    singleVideoFeaturesList: '15 मिनट तक फाइनल|2 रिवीज़न राउंड|कलर ग्रेडिंग|बेसिक साउंड डिज़ाइन',

    monthlyPackageTitle: 'मासिक पैकेज',
    monthlyPackageSubtitle: 'नियमित अपलोडर्स के लिए',
    monthlyPackagePrice: 'कस्टम',
    monthlyPackageFeaturesList: '4-8 वीडियो/माह|प्राथमिकता कतार|थंबनेल शामिल|सुसंगत शैली|तेज़ टर्नअराउंड',

    fullProductionTitle: 'फुल प्रोडक्शन',
    fullProductionSubtitle: 'प्रीमियम कंटेंट के लिए',
    fullProductionPrice: 'कस्टम',
    fullProductionFeaturesList: 'स्क्रिप्टिंग सहायता|एडवांस्ड मोशन ग्राफिक्स|कस्टम एनिमेशन|म्यूज़िक लाइसेंसिंग सहायता|मल्टीपल फॉर्मेट्स',

    // Creator Tiers - Hindi
    starterTierTitle: 'स्टार्टर',
    starterTierPrice: '₹2,500 से',
    starterTierFeaturesList: '10 मिनट तक लॉन्ग-फॉर्म एडिट|बेसिक कलर करेक्शन|सिंपल ट्रांज़िशन|बैकग्राउंड म्यूज़िक सिंक|2 रिवीज़न राउंड',

    proTierTitle: 'प्रो',
    proTierPrice: 'कस्टम',
    proTierFeaturesList: '20 मिनट तक सिनेमैटिक एडिट|एडवांस्ड कलर ग्रेडिंग|मोशन ग्राफिक्स|साउंड डिज़ाइन|अनलिमिटेड रिवीज़न',

    studioTierTitle: 'स्टूडियो',
    studioTierPrice: 'कस्टम',
    studioTierFeaturesList: 'डॉक्यूमेंट्री और सीरीज़|फुल VFX पाइपलाइन|ब्रांड आइडेंटिटी पैकेज|कंटेंट स्ट्रैटेजी|डेडिकेटेड पार्टनर',

    pricingNoteText: 'सभी मूल्य GST को छोड़कर हैं। जल्दबाजी के काम में जटिलता और समय-सीमा के आधार पर अतिरिक्त शुल्क लग सकता है।',

    // Founder Page - Hindi (Complete translations for all hardcoded strings)
    founderHeroTitle: 'संस्थापक का संदेश',
    founderHeroSubtitle: 'quickserveit के पीछे की कहानी',

    founderOpeningQuoteText: '"मैंने quickserveit इसलिए बनाया क्योंकि मैंने एक अंतर देखा — संस्थान डिजिटल अराजकता में डूब रहे थे, क्रिएटर्स असंगत गुणवत्ता से जूझ रहे थे। दोनों को एक साथी की ज़रूरत थी जो उनकी दुनिया को समझे, न कि सिर्फ उनके कार्यों को।"',

    whyIStartedTitle: 'मैंने यह क्यों शुरू किया',
    whyIStartedPara1: 'दोहरी विशेषज्ञता: BCA स्नातक के रूप में, मैं कोड समझता हूं। एक डॉक्यूमेंट्री फिल्ममेकर के रूप में, मैं कहानी समझता हूं। यह अनूठा संयोजन मुझे दो अलग दुनियाओं की समान गहराई से सेवा करने की अनुमति देता है।',
    whyIStartedPara2: 'ग्रामीण गोरखपुर के स्कूलों के साथ काम करते हुए, मैंने प्रिंसिपल और शिक्षकों को डिजिटल कागजी कार्रवाई में डूबते देखा — UDISE+ फॉर्म, परीक्षा रिकॉर्ड, छात्रवृत्ति आवेदन। आवश्यक काम जो उन्हें अपने सर्वश्रेष्ठ काम से दूर खींच रहा था: शिक्षित करना। मेरी तकनीकी पृष्ठभूमि (BCA) ने मुझे इन प्रक्रियाओं को कुशलता से डिजिटाइज़ करने के उपकरण दिए।',
    whyIStartedPara3: 'साथ ही, मेरे डॉक्यूमेंट्री फिल्म निर्माण के अनुभव ने मुझे क्रिएटर अर्थव्यवस्था की वास्तविकता से अवगत कराया। मैंने प्रतिभाशाली शिक्षकों और कहानीकारों को विचारों से नहीं, बल्कि निष्पादन से जूझते देखा — एडिटिंग वर्कफ़्लो, विज़ुअल स्थिरता, उत्पादन बाधाएं। उन्हें एक प्रोडक्शन साथी की ज़रूरत थी जो कथा को समझे, न कि सिर्फ सॉफ्टवेयर को।',

    theGapIFilledTitle: 'मैंने जो अंतर भरा',
    theGapIFilledPara1: 'अधिकांश सेवाएं संस्थागत काम और क्रिएटर काम को अलग ब्रह्मांड मानती हैं। लेकिन मैंने सामान्य धागा देखा: दोनों उन लोगों द्वारा किए जाते हैं जो अपने शिल्प की गहराई से परवाह करते हैं, तकनीकी कार्यों में डूबे हुए जो उनके मिशन से विचलित करते हैं।',
    theGapIFilledPara2: 'स्कूलों को एक और सॉफ्टवेयर प्लेटफॉर्म की ज़रूरत नहीं है। उन्हें एक मानव साथी की ज़रूरत है जो अनुपालन को समझे, गोपनीयता का सम्मान करे, और बिना नाटक के वितरित करे। क्रिएटर्स को वायरल सफलता के वादों की ज़रूरत नहीं है। उन्हें विश्वसनीय उत्पादन सहायता की ज़रूरत है जो उनकी दृष्टि और समय-सीमा का सम्मान करे।',
    theGapIFilledPara3: 'quickserveit उस चौराहे पर मौजूद है — निर्दोष रूप से निष्पादित करने के लिए पर्याप्त तकनीकी, संदर्भ को समझने के लिए पर्याप्त मानवीय, और हमारी विशेषज्ञता के बाहर सब कुछ को ना कहने के लिए पर्याप्त केंद्रित।',

    myCommitmentTitle: 'मेरी प्रतिबद्धता',
    myCommitmentPara1: 'हर प्रोजेक्ट जो हम लेते हैं वह एक विश्वास अभ्यास है। जब कोई स्कूल छात्र रिकॉर्ड साझा करता है, जब कोई क्रिएटर कच्चा फुटेज भेजता है — वे हमें ऐसे काम के साथ भरोसा कर रहे हैं जो मायने रखता है। मैं इसे व्यक्तिगत रूप से लेता हूं।',
    myCommitmentPara2: 'हम पैमाने का पीछा नहीं करते। हम रुझानों का पीछा नहीं करते। हम दो संकीर्ण लेन में उत्कृष्टता का पीछा करते हैं: संस्थागत दस्तावेज़ीकरण और क्रिएटर प्रोडक्शन। वह फोकस हमारी ताकत है।',
    myCommitmentPara3: 'यदि हम गुणवत्ता और शांति के साथ वितरित नहीं कर सकते, तो हम काम नहीं लेते। बस इतना ही।',

    theVisionTitle: 'दृष्टिकोण',
    theVisionPara1: 'अब से पांच साल बाद, मैं चाहता हूं कि quickserveit सबसे बड़े के रूप में नहीं, बल्कि सबसे भरोसेमंद के रूप में जाना जाए। वह साथी जिसके बारे में स्कूल सबसे पहले सोचते हैं जब अनुपालन काम जमा हो जाता है। वह प्रोडक्शन हाउस जिसे क्रिएटर्स सुझाते हैं जब गुणवत्ता मायने रखती है।',
    ...
    pricingInstItem3Name: 'गणित / विज्ञान',
    pricingInstItem3Desc: 'सूत्र, आरेख, समीकरण',
    pricingInstItem3Price: '₹30/पेज',
    pricingInstTab1Highlight: 'बल्क प्रिंटिंग के लिए अनुकूलित त्रुटि-मुक्त फॉर्मेटिंग। समीकरण संपादक, आरेख समर्थन, और प्रोफेशनल लेआउट शामिल है।',

    // Pricing Page - Institutional Tab 2 (Data Services) - Hindi
    pricingInstTab2Label: 'डेटा सेवाएं',
    pricingInstTab2Title: 'डेटा आर्किटेक्चर',
    pricingInstTab2Desc: 'शून्य-अस्वीकृति गारंटी के साथ UDISE+ और छात्रवृत्ति प्रसंस्करण',
    ...
    pricingInstItem6Price: '₹30-₹50',
    pricingInstItem7Name: 'दैनिक तकनीकी सहायता',
    pricingInstItem7Desc: 'सूक्ष्म से भारी कार्य • पूर्ण कार्य दिवस',
    pricingInstItem7Price: '₹99-₹499',
    pricingInstTab2Highlight: 'पहली सबमिशन पर 99.9% स्वीकृति दर। हम बिना किसी अतिरिक्त लागत के पुनः सबमिशन संभालते हैं।',

    // Pricing Page - Institutional Tab 3 (Terms) - Hindi
    pricingInstTab3Label: 'शर्तें',
    pricingInstTab3Title: 'शर्तें और प्रोटोकॉल',
    pricingInstTab3Desc: 'प्रोफेशनल हैंडशेक - स्पष्ट शर्तें, सुरक्षित वर्कफ़्लो',
    pricingInstPolicy1Title: 'भुगतान शर्तें',
    pricingInstPolicy1Item1Label: 'छोटे कार्य: 100% अग्रिम',
    pricingInstPolicy1Item1Desc: 'शुरू करने से पहले पूर्ण भुगतान',
    pricingInstPolicy1Item2Label: 'बड़ा काम: 50% अग्रिम',
    pricingInstPolicy1Item2Desc: 'पुष्टि के बाद ही काम शुरू होता है',
    pricingInstPolicy2Title: 'सुधार नीति',
    pricingInstPolicy2Item1Label: 'मामूली सुधार शामिल',
    pricingInstPolicy2Item1Desc: 'सहमत स्कोप के भीतर',
    pricingInstPolicy2Item2Label: 'नए विचारों का अलग से शुल्क',
    pricingInstPolicy2Item2Desc: 'मूल स्कोप के बाहर देर से परिवर्तन',
    pricingInstTab3Highlight: 'पारस्परिक सम्मान और पारदर्शिता पर निर्मित। हमारी शर्तें दोनों पक्षों की रक्षा करती हैं और सुचारू सहयोग सुनिश्चित करती हैं।',

    // Pricing Page - Creator Tab 1 (Video Plans) - Hindi
    pricingCreatorTab1Label: 'वीडियो',
    pricingCreatorPlan1Name: 'स्टार्टर',
    pricingCreatorPlan1Price: '₹999',
    pricingCreatorPlan1Desc: 'सरल एडिटिंग',
    pricingCreatorPlan1Feature1: 'साफ कट',
    pricingCreatorPlan1Feature2: 'बेसिक कलर करेक्शन',
    pricingCreatorPlan1Feature3: 'स्मूद फ्लो',
    pricingCreatorPlan1Note: 'साफ, प्रोफेशनल बेसिक्स',
    pricingCreatorPlan2Name: 'ग्रोथ',
    pricingCreatorPlan2Price: '₹1,999',
    pricingCreatorPlan2Desc: 'कथा-केंद्रित',
    pricingCreatorPlan2Feature1: 'बेहतर पेसिंग',
    pricingCreatorPlan2Feature2: 'संरचित कहानी कहना',
    pricingCreatorPlan2Feature3: 'बेहतर फ्लो',
    pricingCreatorPlan2Note: 'कथा-केंद्रित एडिटिंग',
    pricingCreatorPlan3Name: 'अथॉरिटी',
    pricingCreatorPlan3Price: '₹2,999',
    pricingCreatorPlan3Desc: 'जटिल एडिटिंग',
    pricingCreatorPlan3Feature1: 'एडवांस्ड कलर ग्रेडिंग',
    pricingCreatorPlan3Feature2: 'मोशन ग्राफिक्स',
    pricingCreatorPlan3Feature3: 'VFX तत्व',
    pricingCreatorPlan3Note: 'प्रीमियम प्रोडक्शन',
    pricingCreatorPlan4Name: 'सीरीज़ प्लान',
    pricingCreatorPlan4Price: '₹4,999',
    pricingCreatorPlan4Desc: 'मल्टी-वीडियो',
    pricingCreatorPlan4Feature1: 'सुसंगत एपिसोडिक',
    pricingCreatorPlan4Feature2: 'लॉन्ग-फॉर्म प्रोडक्शन',
    pricingCreatorPlan4Feature3: 'सीरीज़ ब्रांडिंग',
    pricingCreatorPlan4Note: 'मल्टी-एपिसोड सीरीज़',
    pricingCreatorTab1Highlight: 'सिनेमैटिक कलर ग्रेडिंग के साथ प्रोफेशनल 1080p डिलीवरी। सभी पैकेज में प्लेटफॉर्म-रेडी फॉर्मेटिंग और 2 राउंड तक के रिवीज़न शामिल हैं।',

    // Pricing Page - Creator Tab 2 (Shorts) - Hindi
    pricingCreatorTab2Label: 'शॉर्ट्स',
    pricingCreatorTab2Title: 'वायरल शॉर्ट्स',
    pricingCreatorTab2Desc: 'अधिकतम एंगेजमेंट के लिए एल्गोरिदम-अनुकूलित शॉर्ट-फॉर्म कंटेंट',
    pricingCreatorItem1Name: 'स्टैंडर्ड शॉर्ट्स',
    pricingCreatorItem1Desc: 'साफ एडिट • ट्रेंडिंग ऑडियो • त्वरित डिलीवरी',
    pricingCreatorItem1Price: '₹499',
    pricingCreatorItem2Name: 'प्रीमियम शॉर्ट्स',
    pricingCreatorItem2Desc: 'एडवांस्ड इफेक्ट्स • कस्टम ग्राफिक्स • प्राथमिकता कतार',
    pricingCreatorItem2Price: '₹999',
    pricingCreatorTab2Highlight: 'Instagram Reels, YouTube Shorts, और TikTok के लिए अनुकूलित। ट्रेंडिंग ऑडियो चयन और प्लेटफॉर्म-विशिष्ट फॉर्मेटिंग शामिल है।',

    // Pricing Page - Creator Tab 3 (Design) - Hindi
    pricingCreatorTab3Label: 'डिज़ाइन',
    pricingCreatorDesign1Name: 'मोशन ग्राफिक्स',
    pricingCreatorDesign1Subtitle: '2.5D एनिमेशन और VFX',
    pricingCreatorDesign1Item1Name: 'बेसिक मोशन',
    pricingCreatorDesign1Item1Desc: 'सरल एनिमेशन',
    pricingCreatorDesign1Item1Price: '₹699',
    pricingCreatorDesign1Item2Name: 'एडवांस्ड VFX',
    pricingCreatorDesign1Item2Desc: 'जटिल इफेक्ट्स',
    pricingCreatorDesign1Item2Price: '₹1,999',
    pricingCreatorDesign1Item3Name: 'प्रो VFX',
    pricingCreatorDesign1Item3Desc: 'प्रीमियम प्रोडक्शन',
    pricingCreatorDesign1Item3Price: '₹2,699',
    pricingCreatorDesign1Note: 'इंट्रो, ट्रांज़िशन, लोअर थर्ड्स के लिए परफेक्ट',
    pricingCreatorDesign2Name: 'थंबनेल और स्क्रिप्ट',
    pricingCreatorDesign2Subtitle: 'हाई-CTR डिज़ाइन + स्क्रिप्ट',
    pricingCreatorDesign2Item1Name: 'केवल थंबनेल',
    pricingCreatorDesign2Item1Desc: 'केवल डिज़ाइन',
    pricingCreatorDesign2Item1Price: '₹299',
    pricingCreatorDesign2Item2Name: 'स्ट्रैटेजी + स्क्रिप्ट के साथ',
    pricingCreatorDesign2Item2Desc: 'डिज़ाइन + स्क्रिप्ट + परामर्श',
    pricingCreatorDesign2Item2Price: '₹699',
    pricingCreatorDesign2Note: 'स्क्रिप्ट लेखन, A/B टेस्टिंग मार्गदर्शन शामिल',
    pricingCreatorTab3Highlight: 'आपकी कंटेंट को ऊंचा करने के लिए प्रोफेशनल डिज़ाइन सेवाएं। सभी डिलीवरेबल्स में सोर्स फाइलें और 2 राउंड तक के रिवीज़न शामिल हैं।',

    // Pricing Page - Creator Tab 4 (Terms) - Hindi
    pricingCreatorTab4Label: 'शर्तें',
    pricingCreatorTab4Title: 'शर्तें और वर्कफ़्लो',
    pricingCreatorTab4Desc: 'सुचारू सहयोग के लिए स्पष्ट शर्तें',
    pricingCreatorPolicy1Title: 'भुगतान शर्तें',
    pricingCreatorPolicy1Item1Label: 'छोटे प्रोजेक्ट: 100% अग्रिम',
    pricingCreatorPolicy1Item1Desc: 'शुरू करने से पहले पूर्ण भुगतान',
    pricingCreatorPolicy1Item2Label: 'बड़े प्रोजेक्ट: 50% अग्रिम',
    pricingCreatorPolicy1Item2Desc: 'पुष्टि के बाद काम शुरू होता है',
    pricingCreatorPolicy2Title: 'रिवीज़न नीति',
    pricingCreatorPolicy2Item1Label: '2 राउंड तक रिवीज़न',
    pricingCreatorPolicy2Item1Desc: 'केवल सहमत स्कोप के भीतर',
    pricingCreatorPolicy2Item2Label: 'प्रमुख परिवर्तनों का अलग से शुल्क',
