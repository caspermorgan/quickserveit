...
export const translations = {
  en: {
    ...
    pricingCreatorTab1Label: 'Video Production',
    pricingCreatorPlan1Name: 'Starter Plan',
    pricingCreatorPlan1Price: '₹2,500/video',
    pricingCreatorPlan1Desc: 'Perfect for getting started with professional editing',
    pricingCreatorPlan1Feature1: 'Up to 10 min final video',
    pricingCreatorPlan1Feature2: 'Basic color correction',
    pricingCreatorPlan1Feature3: '2 revision rounds',
    pricingCreatorPlan1Note: 'Ideal for beginners and small channels',
    pricingCreatorPlan2Name: 'Pro Plan',
    pricingCreatorPlan2Price: '₹5,000/video',
    pricingCreatorPlan2Desc: 'Professional quality for serious creators',
    pricingCreatorPlan2Feature1: 'Up to 20 min cinematic edit',
    pricingCreatorPlan2Feature2: 'Advanced color grading',
    pricingCreatorPlan2Feature3: 'Unlimited revisions',
    pricingCreatorPlan2Note: 'Most popular choice for YouTubers',
    pricingCreatorPlan3Name: 'Studio Plan',
    pricingCreatorPlan3Price: '₹10,000/video',
    pricingCreatorPlan3Desc: 'Premium production for top-tier content',
    pricingCreatorPlan3Feature1: 'Documentary & series support',
    pricingCreatorPlan3Feature2: 'Full VFX pipeline',
    pricingCreatorPlan3Feature3: 'Dedicated partner',
    pricingCreatorPlan3Note: 'For professional creators and brands',
    pricingCreatorPlan4Name: 'Enterprise Plan',
    pricingCreatorPlan4Price: 'Custom Quote',
    pricingCreatorPlan4Desc: 'Tailored solutions for large-scale projects',
    pricingCreatorPlan4Feature1: 'Multi-video packages',
    pricingCreatorPlan4Feature2: 'Brand identity package',
    pricingCreatorPlan4Feature3: 'Content strategy included',
    pricingCreatorPlan4Note: 'Contact us for custom pricing',
    pricingCreatorTab1Highlight: 'All plans include professional editing, sound design, and platform optimization.',

    // Tab 2 - Shorts & Reels
    pricingCreatorTab2Label: 'Shorts & Reels',
    pricingCreatorTab2Title: 'Viral Shorts & Reels',
    pricingCreatorTab2Desc: 'Algorithm-optimized vertical content for maximum reach.',
    pricingCreatorItem1Name: 'Single Short/Reel',
    pricingCreatorItem1Desc: 'One high-quality vertical video',
    pricingCreatorItem1Price: '₹500/reel',
    pricingCreatorItem2Name: 'Bulk Package (10 Reels)',
    pricingCreatorItem2Desc: 'Monthly batch production',
    pricingCreatorItem2Price: '₹4,000/month',
    pricingCreatorTab2Highlight: 'Includes kinetic typography, captions, and platform-specific optimization.',

    // Tab 3 - Design Services
    pricingCreatorTab3Label: 'Design Services',
    pricingCreatorDesign1Name: 'Thumbnail Package',
    pricingCreatorDesign1Subtitle: 'High-CTR thumbnail design',
    pricingCreatorDesign1Item1Name: 'Single Thumbnail',
    pricingCreatorDesign1Item1Desc: 'One custom thumbnail',
    pricingCreatorDesign1Item1Price: '₹300',
    pricingCreatorDesign1Item2Name: 'A/B Test Package',
    pricingCreatorDesign1Item2Desc: '3 variants for testing',
    pricingCreatorDesign1Item2Price: '₹800',
    pricingCreatorDesign1Item3Name: 'Monthly Package',
    pricingCreatorDesign1Item3Desc: '10 thumbnails/month',
    pricingCreatorDesign1Item3Price: '₹2,500',
    pricingCreatorDesign1Note: 'Includes competitor analysis and title suggestions',
    pricingCreatorDesign2Name: 'Motion Graphics',
    pricingCreatorDesign2Subtitle: 'Intros, outros, and animations',
    pricingCreatorDesign2Item1Name: 'Logo Intro/Outro',
    pricingCreatorDesign2Item1Desc: '5-10 second animation',
    pricingCreatorDesign2Item1Price: '₹1,500',
    pricingCreatorDesign2Item2Name: 'Lower Thirds Pack',
    pricingCreatorDesign2Item2Desc: 'Animated name tags',
    pricingCreatorDesign2Item2Price: '₹2,000',
    pricingCreatorDesign2Note: 'Custom animations available on request',
    pricingCreatorTab3Highlight: 'Professional design that elevates your brand identity.',

    // Tab 4 - Terms & Policy
    pricingCreatorTab4Label: 'Terms & Policy',
    pricingCreatorTab4Title: 'Terms & Policy',
    pricingCreatorTab4Desc: 'Built on trust, transparency, and creative collaboration.',
    pricingCreatorPolicy1Title: 'Payment Terms',
    pricingCreatorPolicy1Item1Label: 'Small Projects',
    pricingCreatorPolicy1Item1Desc: '100% advance (before starting)',
    pricingCreatorPolicy1Item2Label: 'Large Projects',
    pricingCreatorPolicy1Item2Desc: '50% advance (work starts after confirmation)',
    pricingCreatorPolicy2Title: 'Revision Policy',
    pricingCreatorPolicy2Item1Label: 'Included Revisions',
    pricingCreatorPolicy2Item1Desc: 'As per plan (2 rounds for Starter, unlimited for Pro)',
    pricingCreatorPolicy2Item2Label: 'Scope Changes',
    pricingCreatorPolicy2Item2Desc: 'New ideas or major changes charged separately',
    pricingCreatorDeliveryNote: 'Standard delivery: 7-10 days for long-form, 24-48 hours for shorts/thumbnails.',
