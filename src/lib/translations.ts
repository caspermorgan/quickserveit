...
export const translations = {
  ...
  hi: {
    ...
    // Hero Section - Institutional
    heroInst1: 'आसान डिजिटल काम',
    heroInst2: 'व्यवस्थित शैक्षिक सहायता',
    heroInst3: 'शांत काम, साफ फाइलें',
    heroInst4: 'भरोसेमंद साथी',
    heroInstDesc: 'हम आपके डिजिटल काम को आसान, सुरक्षित और समय पर पूरा करते हैं। परीक्षा से लेकर सरकारी काम तक, आपकी संस्था को शांति मिलनी चाहिए।',

    // Hero Section - Creator
    heroCreator1: 'सिनेमाई कंटेंट',
    heroCreator2: 'प्रोफेशनल एडिटिंग',
    heroCreator3: 'बेहतरीन क्वालिटी',
    heroCreatorDesc: 'हम आपके वीडियो को प्रोफेशनल बनाते हैं। YouTube से लेकर डॉक्यूमेंट्री तक, आपका काम बेहतरीन क्वालिटी का हकदार है।',
    ...
    getQuote: 'कीमत जानें',
    discussRetainer: 'पैकेज पर बात करें',
    ...
    // Stats
    schoolsServed: 'स्कूल',
    projectsDelivered: 'प्रोजेक्ट्स',
    uptimeGuarantee: 'गारंटी',
    documents: 'दस्तावेज़',
    viewsGenerated: 'व्यूज',

    // Contact Form
    contactTitle: 'संपर्क करें',
    contactSubtitle: 'अपने प्रोजेक्ट के बारे में बात करने के लिए फॉर्म भरें।',
    yourName: 'आपका नाम',
    ...
    termsAgree: 'मैं नियमों से सहमत हूं',
    sendMessage: 'भेजें',
    ...
    workingHoursInfo: 'कार्य समय: सुबह 10:00 – दोपहर 3:00 (कार्य समय में जवाब मिलेगा)',
    workingDays: 'सोमवार से शनिवार',
    outsideHoursNote: 'इस समय के बाद के संदेशों का जवाब अगले दिन मिलेगा।',
    ...
    servicesInstDesc: 'स्कूलों के लिए आसान डिजिटल मदद। हर सेवा साफ और व्यवस्थित।',
    servicesCreatorDesc: 'क्रिएटर्स के लिए बेहतरीन प्रोडक्शन। आपके कंटेंट को बेहतर बनाते हैं।',
    beforeYouBegin: 'शुरू करने से पहले',
    beforeYouBeginItems: 'सभी सेवाओं के लिए पहले से जानकारी चाहिए|कार्य समय: सुबह 10:00 – दोपहर 3:00 (सोम-शनि)|कार्य समय में 2 घंटे में जवाब|सभी फाइलें सुरक्षित रहती हैं',
    howItWorks: 'कैसे काम करता है',
    whatYouNeed: 'आपको क्या चाहिए',
    timeline: 'समय',
    whatsappNote: 'WhatsApp खोलने के लिए क्लिक करें',

    // Services - Institutional (simplified)
    examDocTitle: 'परीक्षा का काम',
    examDocShort: 'परीक्षा के सभी कागज़ात और रिकॉर्ड।',
    examDocFull: 'परीक्षा से जुड़ा सभी काम - छात्र डेटा, हॉल टिकट, उपस्थिति, उत्तर पुस्तिका, और रिजल्ट।',
    examDocSteps: 'WhatsApp पर परीक्षा की जानकारी भेजें|कोई भी फॉर्मेट में डेटा दें (Excel, PDF, हस्तलिखित)|हम सब व्यवस्थित करेंगे|आप चेक करें|पूरा पैकेज तैयार मिलेगा',
    examDocNeeds: 'छात्र डेटा (नाम, रोल नंबर, क्लास)|विषय और परीक्षा की तारीख|कोई टेम्पलेट हो तो|अंतिम तारीख',
    examDocTimeline: 'सामान्य: 5-7 दिन | जल्दी: 2-3 दिन (अतिरिक्त शुल्क)',

    scholarshipTitle: 'छात्रवृत्ति की मदद',
    scholarshipShort: 'छात्रवृत्ति के लिए फॉर्म और कागज़ात।',
    scholarshipFull: 'छात्रवृत्ति का पूरा काम - पात्रता जांच, फॉर्म भरना, कागज़ात, और जमा करना।',
    scholarshipSteps: 'छात्रवृत्ति की जानकारी और छात्र लिस्ट भेजें|हम पात्रता चेक करेंगे|परिवारों को कागज़ात की जानकारी देंगे|फॉर्म सही भरेंगे|जमा करने की स्थिति बताएंगे',
    scholarshipNeeds: 'छात्रवृत्ति का नाम और नियम|छात्र लिस्ट|आय प्रमाण पत्र, जाति प्रमाण पत्र (अगर चाहिए)|बैंक खाता',
    scholarshipTimeline: 'सामान्य: 7-10 दिन | परिवारों से कागज़ात पर निर्भर',

    udiseTitle: 'UDISE+ का काम',
    udiseShort: 'UDISE+ डेटा एंट्री और अपडेट।',
    udiseFull: 'साल भर का UDISE+ काम - डेटा इकट्ठा करना, सही एंट्री, चेक करना, और जमा करना।',
    udiseSteps: 'स्कूल डेटा और पिछले साल का रिकॉर्ड भेजें|हम डेटा चेक करेंगे|सही एंट्री करेंगे|आप देख लें|जमा करके पुष्टि देंगे',
    udiseNeeds: 'स्कूल लॉगिन (सुरक्षित)|इस साल का डेटा|बुनियादी ढांचे की जानकारी|शिक्षकों की जानकारी',
    udiseTimeline: 'सामान्य: 3-5 दिन | साल के समय: प्राथमिकता',

    dailySupportTitle: 'रोज़ की मदद',
    dailySupportShort: 'रोज़ के छोटे-छोटे कामों में मदद।',
    dailySupportFull: 'मासिक पैकेज - नोटिस, सर्कुलर, उपस्थिति रिपोर्ट, और छोटे काम।',
    dailySupportSteps: 'मासिक पैकेज लें|WhatsApp पर काम भेजें|उसी दिन या अगले दिन मिलेगा|महीने का सारांश मिलेगा|जरूरत के हिसाब से काम',
    dailySupportNeeds: 'रोज़ के कामों की लिस्ट|संपर्क की जानकारी|महीने में कितना काम होगा',
    dailySupportTimeline: 'आसान काम: उसी दिन | मुश्किल काम: 24-48 घंटे',

    // Services - Creator (simplified)
    videoEditTitle: 'वीडियो एडिटिंग',
    videoEditShort: 'YouTube, डॉक्यूमेंट्री और शैक्षिक वीडियो की एडिटिंग।',
    videoEditFull: '10+ मिनट के वीडियो के लिए प्रोफेशनल एडिटिंग - कट्स, ट्रांज़िशन, टेक्स्ट, और एंगेजमेंट।',
    videoEditSteps: 'Google Drive या WeTransfer पर फुटेज भेजें|जानकारी दें: मुख्य पॉइंट्स, स्टाइल, लंबाई|पहला कट मिलेगा|देखें और बदलाव बताएं (2 राउंड)|फाइनल वीडियो मिलेगा',
    videoEditNeeds: 'कच्चा फुटेज (व्यवस्थित)|कोई B-roll या एसेट्स|म्यूज़िक की पसंद|रेफरेंस वीडियो',
    videoEditTimeline: 'सामान्य: 15-20 मिनट वीडियो के लिए 7-10 दिन',

    thumbnailTitle: 'थंबनेल और डिज़ाइन',
    thumbnailShort: 'क्लिक बढ़ाने वाले थंबनेल और ग्राफिक्स।',
    thumbnailFull: 'आकर्षक थंबनेल, चैनल आर्ट, एंड स्क्रीन और सोशल मीडिया ग्राफिक्स।',
    thumbnailSteps: 'वीडियो टॉपिक बताएं|फेस शॉट या फ्रेम दें|2-3 ऑप्शन मिलेंगे|चुनें और बदलाव बताएं|सभी साइज़ में मिलेगा',
    thumbnailNeeds: 'वीडियो टाइटल और टॉपिक|अच्छी क्वालिटी का फोटो|कोई टेक्स्ट|रंग की पसंद',
    thumbnailTimeline: 'सामान्य: 24-48 घंटे | जल्दी: उसी दिन',

    motionTitle: 'मोशन ग्राफिक्स',
    motionShort: 'इंट्रो, आउट्रो, और एनिमेशन।',
    motionFull: 'एनिमेटेड लोगो, सब्सक्राइब बटन, ट्रांज़िशन, और इंट्रो/आउट्रो।',
    motionSteps: 'ब्रांड फाइलें और स्टाइल बताएं|एनिमेशन स्टाइल पर बात करें|स्केच या स्टोरीबोर्ड मिलेगा|एनिमेटेड ड्राफ्ट देखें|फाइनल फाइलें मिलेंगी',
    motionNeeds: 'लोगो फाइलें|ब्रांड रंग और फॉन्ट|रेफरेंस एनिमेशन|समय और फॉर्मेट',
    motionTimeline: 'इंट्रो/आउट्रो: 5-7 दिन | सिंपल: 2-3 दिन',

    strategyTitle: 'कंटेंट स्ट्रैटेजी',
    strategyShort: 'प्लानिंग, स्क्रिप्टिंग और कैलेंडर।',
    strategyFull: 'टॉपिक रिसर्च, स्क्रिप्ट, अपलोड शेड्यूल और परफॉर्मेंस एनालिसिस।',
    strategySteps: 'चैनल के लक्ष्य बताएं|निश और ऑडियंस पर बात करें|कंटेंट कैलेंडर मिलेगा|साथ में रिव्यू करें|लगातार या एक बार की मदद',
    strategyNeeds: 'चैनल लिंक और एनालिटिक्स|कंटेंट लक्ष्य|जो टॉपिक्स कवर करने हैं|कितनी बार पोस्ट करते हैं',
    strategyTimeline: 'शुरुआती: 5-7 दिन | लगातार: हफ्ते/महीने का पैकेज',
