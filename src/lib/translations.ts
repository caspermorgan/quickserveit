...
export const translations = {
  en: {
    ...
    heroInst1: 'Your Digital Burden, Lifted',
    heroInst2: 'Compliance Made Simple',
    heroInst3: 'Accurate Documentation, On Time',
    heroInst4: 'Trusted by Schools Across Gorakhpur',
    heroInstDesc: 'Trusted by schools across Gorakhpur for exam documentation, scholarship processing, and compliance support. We handle the technical work so you can focus on education.',

    // Hero Section - Creator
    heroCreator1: 'Production That Positions You as an Authority',
    heroCreator2: 'Editing That Keeps Viewers Watching',
    heroCreator3: 'Broadcast-Quality Results, Creator-Friendly Pricing',
    heroCreatorDesc: 'Professional editing, cinematic color grading, and retention-focused storytelling. Limited availability for serious creators ready to elevate their content.',
    ...
    valueSecurityTitle: 'Your Data is Sacred',
    valueSecurityDesc: 'Student records and exam papers handled with bank-level security. We never share, never showcase, never compromise. Your trust is our foundation.',
    valueTimelyTitle: 'Deadlines Met, Every Time',
    valueTimelyDesc: 'Academic calendars don\'t wait—neither do we. Clear timelines, regular updates, and delivery you can count on. No surprises, no excuses.',
    valuePersonalTitle: 'Real People, Real Support',
    ...
    valueReliableTitle: 'Consistent, Dependable Results',
    valueReliableDesc: 'Trusted by schools across Gorakhpur for UDISE+, scholarships, and exam documentation. We deliver the same high quality, every single time—no drama, no excuses.',

    // Creator Values
    valueQualityTitle: 'Editing That Keeps Viewers Watching',
    valueQualityDesc: 'Every cut, transition, and effect engineered for retention. Your viewers stay engaged, your watch time climbs, and your channel grows—naturally.',
    valueFastTitle: 'Never Miss an Upload Schedule',
    valueFastDesc: 'Clear timelines, honest communication, and delivery that respects both quality and your audience. We keep you on schedule without cutting corners.',
    valueCreativeTitle: 'We Get Your Vision',
    valueCreativeDesc: 'We don\'t just follow instructions—we understand your creative intent and bring it to life with precision. Your message lands exactly as you imagined.',
    valueCommittedTitle: 'Your Growth is Our Mission',
    ...
    // About Page
    aboutTitle: 'About',
    aboutIntro: 'We exist to lift the digital burden from people doing meaningful work—educators shaping the next generation and creators building engaged audiences.',
