...
const ServiceCard = ({ icon: Icon, title, description, mode, delay = 0 }: ServiceCardProps) => {
  return (
    <div
      className="group relative glass-card border-white/10 hover:border-white/20 rounded-2xl p-6 md:p-8 animate-fade-in-up hover:shadow-2xl transition-all duration-500"
