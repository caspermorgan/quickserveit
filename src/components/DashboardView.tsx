...
const DashboardView = ({ mode, onReturn, isEntering }: DashboardViewProps) => {
  ...
  return (
    <div 
      className={`fixed inset-0 z-40 bg-background transition-all duration-1000 ${
        isEntering 
    ...
    >
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 w-10 h-10 md:w-12 md:h-12 rounded-full glass-nav flex items-center justify-center transition-all duration-700 ${
          showBackToTop 
